...
docker run --name rococo-db -p 5432:5432 -e POSTGRES_PASSWORD=secret -e CREATE_DATABASES=rococo-artists,rococo-auth,rococo-countries,rococo-files,rococo-museums,rococo-paintings,rococo-users -e TZ=GMT+3 -e PGTZ=GMT+3 -v rococo_pgdata:/var/lib/postgresql/data -v ./env/docker/postgres:/docker-entrypoint-initdb.d -d postgres:16.8 --max_prepared_transactions=100
